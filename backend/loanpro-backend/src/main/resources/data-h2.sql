-- ===========================================================================
-- H2-compatible seed data (used only by the "h2" Spring profile).
-- The H2 schema is recreated on every boot (ddl-auto=create-drop), so plain
-- INSERTs are safe — no PostgreSQL-specific "ON CONFLICT" needed.
-- BCrypt hashes correspond to: admin123 / customer123.
-- ===========================================================================
...
INSERT INTO loan_types (name, code, max_limit, description, min_interest_rate, max_interest_rate, active) VALUES
